...
public class CancelAppointment extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(obj.equals(btn_save)) JOptionPane.showMessageDialog(null, "Changes Saved Successfully!");
        if(obj.equals(btn_cancel)) JOptionPane.showMessageDialog(null, "Appointment Cancelled Successfully!");
